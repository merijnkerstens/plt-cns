...
directory="/lustre/BIF/nobackup/boele028/SA_2023/promoters_PLT/111124_20kb-cds_plt-chopped/prepping_promoters_monocots"
...
for fasta_file in ${directory}/*_truncated_promoters_minlen50.fasta; do
    ...
    meme ${fasta_file} -dna -oc "./zoops_monocot_${file_name_no_ext}" -mod zoops -nmotifs 15 -minw 15 -maxw 100 -objfun classic -minsites 15 -markov_order 0 
